...
const projects = [
  { id: 1, name: "Swarovski Flagship", loc: "Vienna, AT", client: "Swarovski", status: "In Production", progress: 72, pm: "Nils Holert", phase: "Manufacturing", due: "Apr 15, 2026", budget: 840000, spent: 605000, team: ["Nils Holert","Tina Jiao","Kelvin Lee"], contact: "Maria Schmidt", contactEmail: "m.schmidt@swarovski.com", contactPhone: "+43 1 234 5678", mondayId: "MON-2841", epicorJob: "JOB-2026-0041" },
  { id: 2, name: "Ganni Store", loc: "Copenhagen, DK", client: "Ganni", status: "Design Review", progress: 35, pm: "Viet Nga Le", phase: "Technical Dev", due: "Jun 22, 2026", budget: 520000, spent: 182000, team: ["Viet Nga Le","Yang Yang"], contact: "Lars Andersen", contactEmail: "l.andersen@ganni.com", contactPhone: "+45 33 123 456", mondayId: "MON-2856", epicorJob: "JOB-2026-0055" },
  { id: 3, name: "Gaggenau Showroom", loc: "Shanghai, CN", client: "Gaggenau", status: "On Site", progress: 91, pm: "Tina Jiao", phase: "Installation", due: "Mar 18, 2026", budget: 1200000, spent: 1092000, team: ["Tina Jiao","Chen Hao","Kelvin Lee","Nils Holert"], contact: "Thomas Berger", contactEmail: "t.berger@gaggenau.com", contactPhone: "+86 21 5678 9012", mondayId: "MON-2803", epicorJob: "JOB-2025-0098" },
  { id: 4, name: "Kudos Boutique", loc: "Kuala Lumpur, MY", client: "Kudos", status: "Planning", progress: 12, pm: "Kelvin Lee", phase: "Concept Design", due: "Sep 01, 2026", budget: 380000, spent: 45600, team: ["Kelvin Lee","Viet Nga Le"], contact: "Ahmad Razak", contactEmail: "a.razak@kudos.my", contactPhone: "+60 3 2345 6789", mondayId: "MON-2871", epicorJob: "JOB-2026-0067" },
  { id: 5, name: "De Bijenkorf Renovation", loc: "Amsterdam, NL", client: "De Bijenkorf", status: "In Production", progress: 58, pm: "Nils Holert", phase: "Manufacturing", due: "May 30, 2026", budget: 1500000, spent: 870000, team: ["Nils Holert","Viet Nga Le","Yang Yang","Chen Hao"], contact: "Jan de Vries", contactEmail: "j.devries@debijenkorf.nl", contactPhone: "+31 20 987 6543", mondayId: "MON-2819", epicorJob: "JOB-2026-0012" },
];
...
const openPoints = [
  ...
  { id: 3, project: "Ganni Store", title: "Material selection: fitting room panels", priority: "High", owner: "Oldenburger", assignedTo: "Viet Nga Le", created: "Feb 18", days: 12, desc: "3 material options presented, client prefers option B — need final costing" },
  ...
  { id: 7, project: "De Bijenkorf", title: "Structural engineer report pending", priority: "High", owner: "Oldenburger", assignedTo: "Yang Yang", created: "Feb 15", days: 15, desc: "Third-party structural assessment for ceiling mounts — report due Mar 5" },
...
const drawings = [
  { id: 1, name: "SWV-FL-DWG-001", project: "Swarovski Flagship", desc: "Main display wall — oak veneer panel layout", status: "Pending", by: "Yang Yang", date: "Feb 28", comments: 2, sharepoint: "Projects/Swarovski/Drawings/" },
  { id: 2, name: "GAN-CP-DWG-003", project: "Ganni Store", desc: "Fitting room partition — cross-section", status: "Revision", by: "Viet Nga Le", date: "Feb 25", comments: 5, sharepoint: "Projects/Ganni/Drawings/" },
  { id: 3, name: "GAG-SH-DWG-012", project: "Gaggenau Showroom", desc: "Kitchen island — CNC cutting plan", status: "Approved", by: "Chen Hao", date: "Feb 20", comments: 1, sharepoint: "Projects/Gaggenau/Drawings/" },
  { id: 4, name: "BIJ-AM-DWG-007", project: "De Bijenkorf", desc: "Entrance fixture — steel frame detail", status: "Pending", by: "Yang Yang", date: "Mar 01", comments: 0, sharepoint: "Projects/Bijenkorf/Drawings/" },
];
